...
const orionModels = [
  { id: "orion-2.2", label: "Orion 2.2" },
  { id: "orion-atlas", label: "Orion Atlas" },
  { id: "orion-niro", label: "Orion Niro" },
] as const;
...
function PureMultimodalInput({
  ...
  const [orionModel, setOrionModel] = useState("orion-2.2");
  ...
  return (
    <div className={cn("relative flex w-full flex-col gap-4", className)}>
      ...
      <PromptInput
        className="[&>div]:rounded-2xl [&>div]:border [&>div]:border-border/60 [&>div]:bg-card/70 [&>div]:shadow-[var(--shadow-composer)] [&>div]:shadow-sm"
        onSubmit={() => {
          if (input.startsWith("/")) {
      ...
      >
        ...
        <PromptInputTextarea
          className="min-h-24 text-[13px] leading-relaxed px-4 pt-3.5 pb-1.5 placeholder:text-muted-foreground/80 caret-black dark:caret-white"
        ...
        <PromptInputFooter className="px-3 pb-3">
          ...
          <div className="flex items-center gap-2">
            <Popover onOpenChange={setModelMenuOpen} open={modelMenuOpen}>
              ...
              <PopoverContent
                align="end"
                className="w-40 rounded-xl border border-border/50 bg-card p-1.5 shadow-[var(--shadow-float)]"
                side="top"
                sideOffset={8}
              >
                <div className="flex flex-col gap-0.5">
                  {orionModels.map((model) => (
                    <button
